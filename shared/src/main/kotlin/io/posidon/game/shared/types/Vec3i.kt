...
data class Vec3i(var x: Int, var y: Int, var z: Int) {
    ...
    inline infix fun dot(other: Vec3i) = x * other.x + y * other.y + z * other.z
    inline infix fun cross(other: Vec3i) = Vec3i(y * other.z - z * other.y, z * other.x - x * other.z, x * other.y - y * other.x)
